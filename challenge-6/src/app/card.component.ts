  ...
  template: `
    <div class="card p-0 bg-body-tertiary rounded">
      <div class=" card-body d-flex flex-column align-items-center p-0">
        <div
          class="d-flex align-items-center justify-content-center w-100 border-0 p-3"
        >
        ...
        <div class="w-100 border-bottom bg-white">
          <p
            class="card-text overflow-y-auto px-4 py-2 text-start"
            style="word-spacing: 0.5em; height: 300px"
          >
            {{ content }}
          </p>
        </div>
